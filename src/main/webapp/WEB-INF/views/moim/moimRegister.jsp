    ...
    <table class="input-form" >
      ...
      <col style="width:auto;"> 
            ...
            <tr>
               ...
               <td class="contents">
                  ...
                  <span style="color:#fd8731;">*</span>
                   <input type="text" name="MO_DETAILCATEGORY" class="mo_detailca" placeholder="예) 뮤지컬" style ="width:363px;">
               </td>
            </tr>
         ...
         <tr>
            ...
            <td class="contents">
               <textarea style="width: 100%;" rows="17" class="form-control" style ="border-radius:30px;"
               name="MO_DETAIL" placeholder="내용 작성" class="form-control" id="textArea_byteLimit" name="textArea_byteLimit" onkeyup="fn_checkByte(this)" wrap="hard" cols = ""></textarea>
                 <sup>(<span id="nowByte">0</span>/1800bytes)</sup>
            </td>
         </tr> 
         ...
         <tr>
            ...
            <span>상세이미지</span><br>
              <span><input type="file" id="file" name="file_0">
               <a
                  href="#this" class="mrgbtn" id="delete" name="delete">삭제</a>
                  <a
                  href="#this" class="mrgbtn" id="addFile">파일 추가</a></span>
            </td>
         </tr>   
   </tbody>
   </table>
